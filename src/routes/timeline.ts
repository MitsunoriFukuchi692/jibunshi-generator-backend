...
router.post('/', authenticate, async (req: Request, res: Response) => {
  try {
    ...
    let event_year: number | null = null;
...
router.get('/:timelineId/photos', authenticate, async (req: Request, res: Response) => {
  try {
...
router.post('/:timelineId/photos', authenticate, async (req: Request, res: Response) => {
  try {
    const { timelineId } = req.params;
    const user = (req as any).user;
...
router.delete('/:timelineId/photos/:photoId', authenticate, async (req: Request, res: Response) => {
  try {
...
// ============================================
router.post('/:timelineId/metadata', authenticate, async (req: Request, res: Response) => {
  try {
    const user = (req as any).user;
    const { timelineId } = req.params;
